  ...
  <div className="space-y-6">
    ...
    <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
      {[...Array(4)].map((_, index) => (
        <Card
          key={index}
          className="bg-white/95 shadow-sm border border-gray-100 rounded-3xl"
        >
    ...
    <div className="grid gap-6 grid-cols-1 lg:grid-cols-2">
      ...
      <Card className="lg:col-span-2 bg-white/95 shadow-sm border border-gray-100 rounded-3xl">
        <CardHeader>
          <div className="h-4 w-1/3 bg-gray-200 animate-pulse rounded"></div>
        </CardHeader>
        <CardContent className="h-80">
