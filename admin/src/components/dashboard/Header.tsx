import { Search, X, Bell, ChevronDown, LogOut } from "lucide-react";
      ...
      <div className="flex items-center gap-1 md:gap-2 shrink-0">
        ...
        <Sheet>
          ...
          <SheetContent className="w-[400px] sm:w-[540px] flex flex-col pt-6 px-6 pb-6">
            <SheetHeader className="pb-4 border-b border-gray-100 flex flex-row items-center justify-between space-y-0">
