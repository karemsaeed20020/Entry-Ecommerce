...
interface PaymentGatewayDialogProps {
  ...
  onClose: () => void;
  orderTotal: number;
  selectedGateway: "stripe" | "sslcommerz" | null;
  onGatewaySelect: (gateway: "stripe" | "sslcommerz") => void;
  onConfirm: (gateway: "stripe" | "sslcommerz") => void;
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="py-2">
          <RadioGroup
            ...
            onValueChange={(value) =>
              onGatewaySelect(value as "stripe" | "sslcommerz")
            }
            className="space-y-3"
          >
            {/* Stripe Option */}
            <div
              ...
              onClick={() => onGatewaySelect("stripe")}
            >
              {selectedGateway === "stripe" && (
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <Label htmlFor="stripe" className="cursor-pointer block">
