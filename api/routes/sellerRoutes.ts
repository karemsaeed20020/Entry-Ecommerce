...
router.route("/profile").put(protect, updateSellerProfile);

// Seller Order Routes
router.route("/orders").get(protect, getSellerOrders);
router.route("/orders/:id").get(protect, getSellerOrderById);
