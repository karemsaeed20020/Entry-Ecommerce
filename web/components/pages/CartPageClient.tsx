...
const CartPageClient = () => {
  ...
  const handleApplyCoupon = async () => {
    ...
    if (!auth_token) {
      toast.error("You must be logged in to use a coupon");
      return;
    }
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        toast.error(response.error?.message || "Invalid coupon code");
      }
    } catch (error: any) {
        ...
        <div className="xl:col-span-1">
          <div className="bg-background rounded-2xl p-6 sticky top-30 border border-gray-100 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              {appliedCoupon && (
                <div className="flex justify-between items-center py-2 text-green-600 bg-green-50 px-3 rounded-lg border border-green-100">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px]">
                      {appliedCoupon.discountType === "percent" ? `${appliedCoupon.discountValue}%` : "Fixed"} Discount
                    </span>
                  </div>
              ...
              <div className="flex justify-between items-center py-2">
                ...
                <PriceFormatter
                  amount={calculateSubtotal() * parseFloat(process.env.NEXT_PUBLIC_TAX_AMOUNT || "0")}
                  className="text-base font-medium text-gray-900"
                />
              </div>
