...
export default function OrdersPage() {
  ...
  const handleDownloadInvoice = async (order: Order) => {
    const subtotal = order.items.reduce((a, i) => a + (i.price || 0) * i.quantity, 0);
    const shipping = 15; // Standard shipping for admin
    const tax = subtotal * 0; // Assume 0 tax for now or calculate if needed
    ...
    const invoiceData: InvoiceData = {
      ...
      shipping,
      tax,
      total: order.totalAmount || order.total || subtotal + shipping + tax,
