...
const FeaturesPageClient = ({
  ...
  const fetchProducts = useCallback(
    async (loadMore = false) => {
      ...
      try {
        const params = new URLSearchParams();
        // Force featured products but allow other filters
        params.append("productType", "_featured_products"); 
      ...
      <div className="py-10">
        <div className="mb-5">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator /><BreadcrumbItem><BreadcrumbPage>Featured Products</BreadcrumbPage></BreadcrumbItem>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 text-gray-600">
              ...
              <Button variant="ghost" size="sm" className="h-6 px-2 text-xs flex items-center gap-1.5" onClick={async () => {
                  ...
                  if (navigator.share) {
                    try { await navigator.share({ title: "Featured Products - " + document.title, url }); }
        ...
        <div className="flex flex-col md:flex-row gap-5">
          ...
          <div className="bg-background p-5 rounded-md w-full">
            ...
            ) : ( !loading && <EmptyListDesign message="No featured products match your filters." resetFilters={resetAllFilters} /> )}
          </div>
        </div>
      </div>
    </Container>
